...
void CaptureWidget::updateButtons() {
    // lijing
    qDebug() << "CaptureWidget::updateButtons";
...
// lijing
void CaptureWidget::mouseDoubleClickEvent(QMouseEvent *e)
{
...
void CaptureWidget::stopCapture()
{
...
// lijing
void CaptureWidget::showPreviewWindow()
{
    close();
    ScreenshotSaver().saveToFilesystem(m_context.selectedScreenshotArea());
    QProcess::execute("yadang");
}
